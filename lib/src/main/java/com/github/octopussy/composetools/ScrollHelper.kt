...
fun Modifier.scrollHelper(
    ...
    fun scrollTo() {
        ...
        coroutineScope.launch {
            val gapPx = scrollBottomGap.value * density.density
            val f = scrollState.value + verticalPos - parentRect.height + viewSize.height  + gapPx
            scrollState.animateScrollTo((f).toInt())
        }
    }
